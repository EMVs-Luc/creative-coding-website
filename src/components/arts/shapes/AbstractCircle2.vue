            ...
            script: function (p5) {
                ...
                p5.draw = _ => {
                    ...
                    for(let circle in circles){
                        ...
                        if(p5.dist(random_point_x,random_point_y, circleSmallestDistance[0][0],circleSmallestDistance[0][1]) - circleSmallestDistance[1]  >
                            p5.dist(random_point_x,random_point_y, circle[0][0],circle[0][1]) - circle[1]){
                            circleSmallestDistance = circle
                        }
                    }

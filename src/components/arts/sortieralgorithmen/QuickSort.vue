        ...
        return{
            ...
            script: function (p5) {
                ...
                p5.setup = _ => {
                    ...
                    buttonNewGenerate.mousePressed(function (){pivotAreaPos=[];pivotAreaNeg=[]; numberListRAW = [];  pivotPoint = []; numberList=[]; updateNumbers();})
                ...
                p5.draw = _ => {
                    ...
                    for(let i = 0; i < numberList.length; i++){
                        ...
                        if(number === pivotPoint){
                            p5.strokeWeight(5)
                            p5.stroke(255, 204, 0);
                        } else if(pivotAreaPos.includes(number)){
                            p5.strokeWeight(5)
                            p5.stroke(0, 190, 100);
                        } else if(pivotAreaNeg.includes(number)){
                            p5.strokeWeight(5)
                            p5.stroke(190, 0, 0);
                        }
                ...
                function quickSortPivot(array){
                    ...
                    for(let i = 1; i< array.length; i++){
                        if(array[i] > pivot) outputBigger.push(array[i])
                        else outputSmaller.push(array[i])
                    }


                    pivotAreaPos = outputBigger;
                    pivotAreaNeg = outputSmaller
                    return [outputSmaller,[pivot],outputBigger]
                ...
                async function sortOneStep(){
                    ...
                    if(numberListRAW.length === 0) {
                        numberListRAW.push(numberList);
                    }

                    let newNumberListRAW = [];
                    ...
                    let usedSort = false;
                    for(let i = 0; i < numberListRAW.length; i++){
                        if(numberListRAW[i].length <= 1 || usedSort) {
                            newNumberListRAW.push(numberListRAW[i])
                            continue;
                        }
                        usedSort = true;
                        console.log(newNumberListRAW)
                        newNumberListRAW = newNumberListRAW.concat(quickSortPivot(numberListRAW[i]));
                    }

                    numberListRAW = newNumberListRAW
                    ...
                    let newNumberList = [];
                    for(let i = 0; i < numberListRAW.length; i++){
                        for(let iSmall = 0; iSmall < numberListRAW[i].length; iSmall++){
                            newNumberList.push(numberListRAW[i][iSmall])
                        }
                    }
